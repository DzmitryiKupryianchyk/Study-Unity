...
public class RobotController : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        {
            //if (Input.GetKey(KeyCode.S) || Input.GetKey(KeyCode.DownArrow)) rb.transform.Rotate(Vector3.up * rotationSpeed * Time.deltaTime);
            //else rb.transform.Rotate(Vector3.down * rotationSpeed * Time.deltaTime);
        ...
        {
            //if (Input.GetKey(KeyCode.S) || Input.GetKey(KeyCode.DownArrow)) rb.transform.Rotate(Vector3.down * rotationSpeed * Time.deltaTime);
            //else rb.transform.Rotate(Vector3.up * rotationSpeed * Time.deltaTime);
            float turn = Input.GetAxis("Horizontal");
